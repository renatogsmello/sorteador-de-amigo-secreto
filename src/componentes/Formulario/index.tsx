    ...
    <form onSubmit={adicionaParticipante}>
      <div className="mb-8">
        <input
          ...
          className=" rounded-s-[45px] h-[82px] w-2/3 box-border pl-8 text-xl border-2 border-black shadow-[0_2px_0_1px_rbg(0,0,0)] focus:outline-none"
        />
        <button
          disabled={!nome}
          className="rounded-e-[45px] h-[82px] w-1/3 box-border border-2 border-black text-xl text-black shadow-[2px_2px_0_1px_rbg(0,0,0)] cursor-pointer bg-[#c4c4c4] hover:opacity-80 disabled:opacity-60 disabled:cursor-not-allowed "
        >
          Adicionar
        </button>
      </div>
